...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    http.authorizeRequests()//
        ...
        .antMatchers("/persons/about").permitAll()//   
        .antMatchers("/persons/img").permitAll()//  
        .antMatchers("/persons/couverture").permitAll()//   
       
        .antMatchers("/productsdone").permitAll()//  
        .antMatchers("/productsdone/status").permitAll()//        

        .antMatchers("/productsdone/all").permitAll()//        


        .antMatchers("/products/{idpro}").permitAll()//
        .antMatchers("/products/bod/{idpro}").permitAll()//
